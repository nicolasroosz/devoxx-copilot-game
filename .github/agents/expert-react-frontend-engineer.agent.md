...
tools: ["search", "search/changes", "search/codebase", "search/fileSearch", "search/listDirectory", "search/textSearch", "search/usages", "edit", "edit/createDirectory", "edit/createFile", "edit/editFiles", "execute", "execute/createAndRunTask", "execute/getTerminalOutput", "execute/runInTerminal", "read", "read/problems", "read/readFile", "read/terminalLastCommand", "read/terminalSelection", "web", "web/fetch", "browser", "vscode", "vscode/extensions", "vscode/runCommand", "vscode/newWorkspace"]
---
